...
import {
  ...
  IconBrandLinkedin,
  IconBrandXing,
} from '@tabler/icons-react'; // Updated to include all necessary icons
...
export default function Home() {
  ...
  const renderTempPaymeAd = useCallback(
    (position) => {
      ...
      const imageSrc = mobileCheck
        ? mobilePaymeBannerImage.src
        : desktopPaymeBannerImage.src;
  ...
  return (
    ...
    >
      ...
      {/* 
        Load Google Ads
        Commented out to replace with temporary ads.
      */}
      {/*
      ...
      */}
      ...
      <AppShell.Main>
        ...
        {/* Top Ad - Replaced with Temporary Ad */}
        {/* {hasTopAd && (
        ...
        {/* Middle Ad - Replaced with Temporary Ad */}
        {/* {hasMiddleAd && (
          <Center style={{ minHeight: '90px', marginBottom: '1rem' }}>
        ...
        {/* Large Middle Ad - Replaced with Temporary Ad */}
        {/* 
          If you want to replace the large middle ad as well, uncomment and modify accordingly.
        */}
        {/* {hasLargeMiddleAd && (
        ...
        {renderTempPaymeAd('middle')} {/* Using 'middle' position for large ad */}
        ...
        {/* Bottom Ad - Replaced with Temporary Ad */}
        {/* {hasBottomAd && (
