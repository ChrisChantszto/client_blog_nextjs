...
export default function Jetso() {
  ...
  const [hasMiddleAd3, setHasMiddleAd3] = useState(true);
  ...
  useEffect(() => {
    const timer = setTimeout(() => {
      ...
      checkAdContent('div-gpt-ad-1728872550749-0', setHasMiddleAd3);
...
<Script id="gpt-init-desktop" strategy="afterInteractive">
  {`
    ...
    googletag.cmd.push(function() {
      ...
      googletag.pubads().setTargeting('site', ['playeateasy.com']).setTargeting('environment', ['desktop']).setTargeting('section', ['category']).setTargeting('content_category', ['jetso']);
