...
import { isMobile } from '../utils/device'; // Imported isMobile utility
...
export default function Travel() {
  ...
  const [userAgent, setUserAgent] = useState(''); // State for userAgent
    ...
    >
      {
        ...
        {`
          ...
          googletag.cmd.push(function() {
            ...
            googletag.pubads().setTargeting('site', ['playeateasy.com']).setTargeting('environment', ['desktop']).setTargeting('section', ['category']).setTargeting('content_category', ['travel']);
      ...
      <AppShell.Main>
        {
          /* 
          Uncomment these lines if you want to display actual ads instead of temporary ads.
        ...
        {
          // Temporary ad instead of actual ad
