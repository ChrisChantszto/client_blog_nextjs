    ...
    <AppShell header={{ height: 60 }} padding="md" style={{ backgroundColor: '#F5F5F5' }}>
      {
        ...
        {`
          ...
          googletag.cmd.push(function() {
            ...
            googletag.pubads().setTargeting('site', ['playeateasy.com']).setTargeting('environment', ['desktop']).setTargeting('section', ['category']).setTargeting('content_category', ['travel', 'bay area']);            googletag.enableServices();
          });
        `}
      </Script> */
      }
      ...
      <AppShell.Main>
        ...
        */}
        {/* <Center style={{ minHeight: '250px', marginTop: '1rem' }}>
          <div id="div-gpt-ad-1728872531921-0" style={{ minWidth: '970px', minHeight: '250px' }}>
            <img src="https://tpc.googlesyndication.com/simgad/228387351466439815" border="0" width="970" height="250" alt="" className="img_ad" />
          </div>
        </Center> */}
        {
          // Temp ad
          ...
          <div style={{ position: 'relative', width: '100%', height: '100%', overflow: 'hidden' }}>
            <Center>
              ...
              <div style={{ position: 'absolute', bottom: '10%', left: '80%', gap: '2.5rem' }}>
                <a
                  href="https://www.facebook.com/playeateasy/"
                  target="_blank"
                ...
                >
                  ...
                  >
                    ...
                    <path
                      d="M25.0189 21.3138L25.5846 17.7226H22.0998V15.3884C22.0998 14.4064 22.5863 13.4469 24.142 13.4469H25.7487V10.3887C24.813 10.2397 23.8676 10.159 22.9201 10.1475C20.0519 10.1475 18.1793 11.8701 18.1793 14.9843V17.7226H15V21.3138H18.1793V30H22.0998V21.3138H25.0189Z"
                      fill="#337FFF"
                    />
                  </svg>
                </a>
                <a
                  href="https://www.instagram.com/playeateasy/?hl=en"
                  target="_blank"
                  rel="noopener noreferrer"
                >
                  <svg
                ...
                <a
                  href="https://www.youtube.com/@playeateasy"
                  target="_blank"
                  rel="noopener noreferrer"
                >
                  <svg
                ...
                <a
                  href="https://www.xiaohongshu.com/user/profile/5de9b4d50000000001007191?xhsshare"
                  target="_blank"
                  rel="noopener noreferrer"
                >
                  <svg
