      ...
      <Script id="gpt-init-desktop" strategy="afterInteractive">
        {`
          ...
          googletag.cmd.push(function() {
            ...
            googletag.pubads().setTargeting('site', ['playeateasy.com']).setTargeting('environment', ['desktop']).setTargeting('section', ['category']).setTargeting('content_category', ['travel', 'bay area']);
