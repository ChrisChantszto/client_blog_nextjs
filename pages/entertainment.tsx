...
import ShoppingPostlist from '@/components/Postlist/ShoppingPostlist';
import ShoppingCampaignblog from '@/components/Campaignblog/ShoppingCampaignblog';
import EntertainmentBanner from '@/components/Categories/EntertainmentBanner';
import EntertainmentPostlist from '@/components/Postlist/EntertainmentPostlist';
import EntertainmentCard from '@/components/Cardlist/EntertainmentCard';
...
<Script id="gpt-init-desktop" strategy="afterInteractive">
  {`
    ...
    googletag.cmd.push(function() {
      ...
      googletag.pubads().setTargeting('site', ['playeateasy.com']).setTargeting('environment', ['desktop']).setTargeting('section', ['category']).setTargeting('content_category', ['entertainment']);
